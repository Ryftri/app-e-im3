// To parse this data:
//
//   import { Convert, GetOnePelajaran } from "./file";
//
//   const getOnePelajaran = Convert.toGetOnePelajaran(json);
//
...
export class Convert {
    public static toGetOnePelajaran(json: string): GetOnePelajaran {
        return cast(JSON.parse(json), r("GetOnePelajaran"));
    }

    public static getOnePelajaranToJson(value: GetOnePelajaran): string {
        return JSON.stringify(uncast(value, r("GetOnePelajaran")), null, 2);
    }
}
