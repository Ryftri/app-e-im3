// To parse this data:
//
//   import { Convert, GetAllMateri } from "./file";
//
//   const getAllMateri = Convert.toGetAllMateri(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface GetAllMateri {
    status:  string;
    message: string;
    materi:  Materi[];
}
...
export class Convert {
    public static toGetAllMateri(json: string): GetAllMateri {
        return cast(JSON.parse(json), r("GetAllMateri"));
    }

    public static getAllMateriToJson(value: GetAllMateri): string {
        return JSON.stringify(uncast(value, r("GetAllMateri")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Materi": o([
        ...
        { json: "yt_link", js: "yt_link", typ: u(null, "") },
        { json: "file_link", js: "file_link", typ: u(null, "") },
