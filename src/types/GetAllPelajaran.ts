// To parse this data:
//
//   import { Convert, GetAllPelajaran } from "./file";
//
//   const getAllPelajaran = Convert.toGetAllPelajaran(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface GetAllPelajaran {
    status:    string;
    message:   string;
    pelajaran: Pelajaran[];
}
...
export class Convert {
    public static toGetAllPelajaran(json: string): GetAllPelajaran {
        return cast(JSON.parse(json), r("GetAllPelajaran"));
    }

    public static getAllPelajaranToJson(value: GetAllPelajaran): string {
        return JSON.stringify(uncast(value, r("GetAllPelajaran")), null, 2);
    }
}
