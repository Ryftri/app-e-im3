// To parse this data:
//
//   import { Convert, GetGuruByID } from "./file";
//
//   const getGuruByID = Convert.toGetGuruByID(json);
//
...
export interface CreatedPelajaran {
...
export class Convert {
    public static toGetGuruByID(json: string): GetGuruByID {
        return cast(JSON.parse(json), r("GetGuruByID"));
    }

    public static getGuruByIDToJson(value: GetGuruByID): string {
        return JSON.stringify(uncast(value, r("GetGuruByID")), null, 2);
    }
}
