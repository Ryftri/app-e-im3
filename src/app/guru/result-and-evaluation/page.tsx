...
import ResultAndEvaluationPage from '@/components/ResultAndEvaluationPage';
import { Question } from '@/types/question';
import { useSearchParams } from 'next/navigation';
import { useEffect } from 'react';

const ResultAndEvaluation = () => {
  ...
  useEffect(() => {
    console.log(JSON.parse(searchParams.get('answers') || '{}'))
    console.log(Number(searchParams.get('score')))
  })

  return <ResultAndEvaluationPage questions={questions} answersQuery={answers} scoreQuery={score} />;
};

export default ResultAndEvaluation;
